...
test('collectUsageOnce enriches session rows with local last-used timestamps', async () => {
  ...
  // This test uses an isolated homeDir, so neutralize any ambient CLAUDE_CONFIG_DIR
  // (which would otherwise redirect claude session-file resolution outside `tmp`).
